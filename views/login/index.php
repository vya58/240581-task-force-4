    ...
    <div class="landing-container">
        <div class="landing-top">
            ...
            <p>Сломался кран на кухне? Надо отправить документы? Нет времени самому гулять с собакой?
                ...
                <a href="<?= Url::to('registration') ?>"><button class="button">Создать аккаунт</button></a>
        </div>
...
<section class="modal enter-form form-modal" id="enter-form">
    ...
    <?php $form = ActiveForm::begin([
        ...
        <?= $form->field($loginForm, 'email')->input('email', ['class' => 'input input-middle']); ?>
        <?= $form->field($loginForm, 'password')->passwordInput(['class' => 'input input-middle']); ?>
